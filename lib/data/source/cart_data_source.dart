...
class CartRemoteDataSource implements ICartDataSource {
  ...
  Future<AddToCartResponse> changeCount(int cartItemId, int count) async {
    final respose = await httpClient.post(
      'cart/changeCount',
      data: {
    ...
    return AddToCartResponse.fromJson(respose.data);
  }
  ...
  Future<CartResponse> getAll() async {
    final respose = await httpClient.get('cart/list');
    return CartResponse.fromJson(respose.data);
  }
}
